...
const AdminDashboard = () => {
    ...
    const fetchInquiries = async () => {
      try {
        ...
        const [inqRes, propRes, statsRes] = await Promise.all([
          axios.get('https://realestatelk.vercel.app/api/inquiries', config).catch(() => ({ data: [] })),
          axios.get('https://realestatelk.vercel.app/api/properties/pending', config).catch(() => ({ data: [] })),
          axios.get('https://realestatelk.vercel.app/api/analytics/stats', config).catch(() => ({ data: { totalTraffic: 0, todayTraffic: 0 } }))
        ]);
  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      ...
      await axios.put(`https://realestatelk.vercel.app/api/inquiries/${id}/status`, { status: newStatus }, config);
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        await axios.delete(`https://realestatelk.vercel.app/api/inquiries/${id}`, config);
  ...
  try {
    ...
    await axios.put(`https://realestatelk.vercel.app/api/properties/${id}/approve`, {}, config);
  ...
  const handleReject = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        await axios.delete(`https://realestatelk.vercel.app/api/properties/${id}`, config);
